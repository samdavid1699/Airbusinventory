...
public class ProductServiceRepository {
	...
	public int cartProduct(Product productDetails, String productId) {

		String query="CART Product set productName='"+productDetails.getProductName()+"',productDescription='"+productDetails.getProductDescription()+"',productCategory='"+productDetails.getProductCategory()+"',units='"+productDetails.getUnits()+"' where productId='"+productId+"' ";
		return jdbcTemplate.update(query);
	}
